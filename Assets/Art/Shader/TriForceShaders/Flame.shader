	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 texCoord16 = IN.ase_texcoord9.xy * float2( 1,1 ) + float2( 0,0 );
				float mulTime13 = _TimeParameters.x * _EffectSpeed;
				float3 temp_output_50_0 = ( mulTime13 + ( WorldPosition * 2.0 ) );
				float2 texCoord11 = IN.ase_texcoord9.xy * float2( 1,1 ) + ( (( float3( float2( 0,-0.3 ) ,  0.0 ) * temp_output_50_0 )*1.0 + 0.0) + float3( 0,0,0 ) ).xy;
				...
				float2 texCoord24 = IN.ase_texcoord9.xy * float2( 1,1 ) + temp_cast_5;
...
Node;AmplifyShaderEditor.ColorNode;3;-1514.083,-274.0204;Inherit;False;Property;_TintColor;Tint Color;1;1;[HDR];Create;True;0;0;0;False;0;False;0.5294118,0.5294118,0.5294118,0;178.2618,22.39939,0,0.5;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
ASEEND*/
//CHKSM=BD8B5367960A61ACEEE3BBC57D4368118B32E4D6